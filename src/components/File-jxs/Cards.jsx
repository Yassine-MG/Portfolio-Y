    ...
    <div className="text-center">
      ...
      <div className="flex flex-wrap justify-evenly dark:text-darkGray text-white ">
        <div className="">
          {" "}
          <Card
            Card="text-center rounded-lg mx-auto p-10 w-[90%] min-h-[300px] md:w-[400px] my-3 lg:w-[500px] bg-[#34333345]"
            h3Content="Coding"
            ...
            description="leading-8 dark:text-darkGray"
          ></Card>
        </div>
        <div className="">
          <Card
            Card="text-center rounded-lg mx-auto p-10 min-h-[300px] w-[90%] md:w-[400px] my-3 lg:w-[500px] bg-[#34333345]"
        ...
        <div className="">
          {" "}
          <Card
            Card="text-center rounded-lg mx-auto p-10 w-[90%] min-h-[300px] sm:w-[92%] md:w-[400px] my-3 lg:w-[500px] bg-[#34333345]"
            h3Content="Designer"
